...
const Hero = () => {
  return (
    <section className="bg-gradient-to-r from-green-400 to-green-500 min-h-screen flex items-center justify-center text-white py-20 text-center">
      <div className="w-full px-4">
        ...
        <div className="flex flex-col md:flex-row justify-center gap-4">
          <NavLink to="/join">
            <button className="bg-amber-800 hover:bg-amber-950 text-white font-semibold py-3 px-6 rounded-md shadow-md transition w-full md:w-auto">
              Join a Cohort
            </button>
          </NavLink>
          <NavLink to="/programs">
